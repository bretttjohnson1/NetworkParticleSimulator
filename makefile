...
run_server: server.o test.o Particle.o Cluster.o vfunctions.o run_client
	g++ server.o test.o Particle.o Cluster.o vfunctions.o -O2 -g -std=c++0x -lpthread -lm -o run_server
...
vfunctions.o: server/vfunctions.h server/vfunctions.c
	g++ -c server/vfunctions.c
